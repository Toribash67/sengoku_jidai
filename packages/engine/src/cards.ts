 ...
 * (`<id>.png`), so the web needs no id→file mapping. Each kind has its own ability (deploy-time
 * and combat-time); additionally, any card may be discarded to reroll a combat's dice.
 */

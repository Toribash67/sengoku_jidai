 ...
 *
 * Orientation: coordinates are rotated 180° from the raw board.svg `<use>`
 * translates because the board.svg tile layers render inside a
 * `transform="rotate(180,…)"` group. Matching that rotation (an exact hex-grid
 * symmetry — adjacency unchanged) aligns the procedural board with the committed
 * terrain background, which is baked from board.svg's *rendered* orientation.
 */
export const riversSource: HexMapSource = {
  ...
  tiles: [
    ...
    { id: "tile2", kind: "land", hexes: [{ q: 3, r: 5 }], features: { valueStars: 1 } },
    { id: "tile3", kind: "sea", hexes: [{ q: 2, r: 5 }], features: { valueStars: 1 } },
    { id: "tile4", kind: "land", hexes: [{ q: 1, r: 6 }], features: { valueStars: 1 } },
    {
      id: "tile5",
      kind: "land",
      hexes: [
    ...
    { id: "tile12", kind: "land", hexes: [{ q: 1, r: 4 }], features: { shellable: true } },
    {
      id: "tile13",
      kind: "land",
      hexes: [{ q: 0, r: 4 }],
    ...
    { id: "tile15", kind: "sea", hexes: [{ q: 3, r: 2 }], features: { valueStars: 1 } },
    {
      id: "tile16",
      kind: "land",
      hexes: [{ q: 2, r: 2 }],
    ...
    { id: "tile19", kind: "land", hexes: [{ q: 3, r: 1 }], features: { shellable: true } },
    { id: "tile20", kind: "land", hexes: [{ q: 2, r: 1 }], features: { valueStars: 2 } },
    { id: "tile21", kind: "land", hexes: [{ q: 1, r: 2 }], features: { shellable: true } },
    {
      id: "tile22",
      kind: "sea",
      hexes: [
